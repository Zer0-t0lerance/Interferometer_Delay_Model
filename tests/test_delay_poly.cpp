...
int main() {
    ...
    Station phys; phys.tide_data.amplitudes.setZero(); phys.tide_data.phases.setZero(); phys.atm_load.coef.setZero();
    StationPoly poly = compute_station_poly(*bad, src, mjd0, utc0, dur, eop, 60.0, 5, 6.0, no_orbit, false, phys);
