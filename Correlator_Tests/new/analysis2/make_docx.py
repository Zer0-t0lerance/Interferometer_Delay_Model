#!/usr/bin/env python
# make_docx.py - собирает OTCHET.md в файл Word с вставленными картинками.
# ВНИМАНИЕ: перезаписывает итоговый отчёт целиком. Если в нём есть правки, сделанные
# руками в Word, они будут потеряны - сначала сохраните копию.
...
OUT = os.path.join(H, "Отчёт по результатам проверки новой модели задержки.docx")
